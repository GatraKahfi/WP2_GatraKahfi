...
<div class="container-fluid">
 ...
 <?php }?>
 <?= $this->session->flashdata('pesan'); ?>
 <a href="" class="btn btn-primary mb-3" datatoggle="modal" data-target="#bukuBaruModal"><i class="fas fa-filealt"></i> Buku Baru</a>
         ...
         <thead>
                 <tr>
                    ...
                    <th scope="col">ISBN</th>
                     ...
                     <th scope="col">Gambar</th<th scope="col">Pilihan</th>
 </tr>
 </thead>
 <tbody>
 <?php
...
$k['kategori'];?></option>
            <?php } ?>
                ...
                <div class="from-group"><input type="text" class="form-control formcontrol-user" id="pengarang" name="pengarang" placeholder="Masukkan 
nama pengarang">
 </div>
 <div class="form-group">
...
data-dismiss="modal"><i class="fas fa-ban"></i> Close</button>
 <button type="submit" class="btn btn-primary"class="fas fa-plus-circle"></i> Tambah</button>
 </div>
 </form>
 </div>
 </div>
